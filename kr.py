...
The API-KEY is required to use ipinfo. You can use ipinfo without API-KEY but there are some limits
like "THERE IS NO Geolocation, ASN & Hostname information WITHOUT API-KEY" and some other limits.
